...
def home():
    ...
    """
    return render_template_string(html_template, url=MPD_URL, kid=KEY_ID, kf=KEY_VALUE)

# هذا السطر ضروري لـ Vercel ليجد التطبيق
